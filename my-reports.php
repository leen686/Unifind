...
$stmt = $conn->prepare("
    ...
    WHERE r.userID = ?
    ORDER BY r.date DESC, r.reportID DESC
");
...
<html lang="en">
  <head>
    ...
    <title>UniFind | My Reports</title>
    <link rel="stylesheet" href="styles.css" />
  </head>

  <body data-page="my-reports">
    ...
    <main class="reports-page">
      <div class="container">
        <div class="page-heading">
          <h1>My Reports</h1>
          <p>View, update, and delete the reports you submitted.</p>
        </div>
              ...
              <?php while ($report = $reports->fetch_assoc()): ?>
                <div class="report-card">
                  ...
                  <div class="actions">
                    ...
                    <a
                      href="edit-report.php?id=<?php echo $report['reportID']; ?>"
                      class="secondary-btn"
                    >
                      Edit
                    </a>
